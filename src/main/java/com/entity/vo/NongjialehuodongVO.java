 ...
 */
public class NongjialehuodongVO  implements Serializable {
	...
	public void setHuodongchatu(String huodongchatu) {
		this.huodongchatu = huodongchatu;
	}
	
	/**
	 * 获取：活动插图
	 */
	public String getHuodongchatu() {
		return huodongchatu;
	}
