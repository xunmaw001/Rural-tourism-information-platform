  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.jingdianleixing"
                placeholder="景点类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="景点等级" prop="jingdiandengji">
        ...
        <div v-else>
          <el-form-item class="input" label="景点等级" prop="jingdiandengji">
          ...
          <el-form-item class="input" label="门票价格" prop="menpiaojiage">
              <el-input v-model="ruleForm.menpiaojiage" 
                placeholder="门票价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="交通状况" prop="jiaotongzhuangkuang">
          <el-select v-model="ruleForm.jiaotongzhuangkuang" placeholder="请选择交通状况">
            <el-option
                v-for="(item,index) in jiaotongzhuangkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="交通状况" prop="jiaotongzhuangkuang">
	      <el-input v-model="ruleForm.jiaotongzhuangkuang"
                placeholder="交通状况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.jingdianfengmian" label="景点封面" prop="jingdianfengmian">
          <file-upload
          tip="点击上传景点封面"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jingdianfengmian" label="景点封面" prop="jingdianfengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jingdianfengmian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.goumaishijian" label="购买时间" prop="goumaishijian">
              <el-input v-model="ruleForm.goumaishijian" 
                placeholder="购买时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开放时间" prop="kaifangshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaifangshijian" label="开放时间" prop="kaifangshijian">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.menpiaojiage = true;
            continue;
	            	            ...
	            	            if(o=='jiaotongzhuangkuang'){
            this.ruleForm.jiaotongzhuangkuang = obj[o];
	    this.ro.jiaotongzhuangkuang = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/jingdianleixing/leixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                        ...
                                        this.jingdiandengjiOptions = "1A,2A,3A,4A,5A".split(',')
                                                          this.jiaotongzhuangkuangOptions = "顺畅,正常,拥堵".split(',')
                                                                                                                                                          },
                                                                                                        // 多级联动参数
                                                                                                                                    info(id) {
      this.$http({
	...
	this.ruleForm.jingdianxiangqing = this.ruleForm.jingdianxiangqing.replace(reg,'../../../ssmsi3i6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
