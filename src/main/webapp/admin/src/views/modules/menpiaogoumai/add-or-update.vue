          ...
          <el-form-item class="input" v-if="ruleForm.goumaishijian" label="购买时间" prop="goumaishijian">
              <el-input v-model="ruleForm.goumaishijian" 
                placeholder="购买时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="景点详情" prop="jingdianxiangqing">
          <el-input v-model="ruleForm.jingdianxiangqing" 
              placeholder="景点详情" clearable  :readonly="ro.jingdianxiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="景点详情" prop="jingdianxiangqing">
              <el-input v-model="ruleForm.jingdianxiangqing" 
                placeholder="景点详情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `menpiaogoumai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.menpiaogoumaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
